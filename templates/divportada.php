...
while($row = mysql_fetch_array($result)) {
			...
			<div align="center" class="clearfix">
	            <a href="https://www.unicach.mx/_/masterpage.php?pag=POSGRA2" class="col-md-4 col-lg-2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img1','','images/footer/01.jpg',1)"><img src="https://www.unicach.mx/_/bin/images/footer/01_off.jpg" class="img-responsive" alt="Posgrados vigentes" height="100" id="img1"></a>
	            <a href="http://escolares.unicach.mx/masterpage.php?pag=CALENDARIO_ESCOLAR" class="col-md-4 col-lg-2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img2','','images/footer/02.jpg',1)"><img src="https://www.unicach.mx/_/bin/images/footer/02_off.jpg" class="img-responsive" alt="Calendario escolar " height="100" id="img2"></a>
	            <a href="http://www.unicach.mx/script/licitaciones/" class="col-md-4 col-lg-2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img3','','images/footer/03.jpg',1)"><img src="https://www.unicach.mx/_/bin/images/footer/03_off.jpg" class="img-responsive" alt="Conoce nuestras licitaciones" height="100" id="img3"></a>
	            <a href="http://contraloria-social.unicach.mx/" class="col-md-4 col-lg-2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img4','','images/footer/04.jpg',1)"><img src="https://www.unicach.mx/_/bin/images/footer/04_off.jpg" class="img-responsive" alt="ContralorÃ­a Social" height="100" id="img4"></a>
	            <a href="http://escolares.unicach.mx/" class="col-md-4 col-lg-2" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('img5','','images/footer/05.jpg',1)"><img src="https://www.unicach.mx/_/bin/images/footer/05_off.jpg" class="img-responsive" alt="DireciÃ³n de Servicios Escolares" height="100" id="img5"></a>
	            <a href="http://escolares.unicach.mx/masterpage.php?pag=B3CA5_VIG3NT35" class="col-md-4 col-lg-2" title="Becas vigentes" onmouseover="MM_swapImage('img6','','images/footer/06.jpg',1)" onmouseout="MM_swapImgRestore()"><img src="https://www.unicach.mx/_/bin/images/footer/06_off.jpg" class="img-responsive" alt="" height="100" id="img6"></a>
